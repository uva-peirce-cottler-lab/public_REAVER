...
boxplot_multcompare(abs(data_mat), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Error VLD |','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
...
boxplot_multcompare(abs(bsxfun(@minus,data_mat,median(data_mat,1))), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Res. Median Error VLD |     ','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
...
boxplot_multcompare(abs(data_mat), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Error VAF |','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',multiple_CI_means(data_mat,0,0));
pbaspect(gca, [x_ax_scale 1 1])
...
fprintf('%s Variance\n',metrics_cell{2})
boxplot_multcompare(abs(bsxfun(@minus,data_mat,median(data_mat,1))), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Res. Median Error VAF |    ','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',0,'StatAnalysis','Variance');
pbaspect(gca, [x_ax_scale 1 1])
...
boxplot_multcompare(abs(data_mat), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Error Diam. |','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',multiple_CI_means(data_mat,0,0));
pbaspect(gca, [x_ax_scale 1 1])
...
fprintf('%s Variance\n',metrics_cell{3})
boxplot_multcompare(abs(bsxfun(@minus,data_mat,median(data_mat,1))), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Res. Median Error Diam. |         ','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',0,'StatAnalysis','Variance');
pbaspect(gca, [x_ax_scale 1 1])
...
boxplot_multcompare(abs(data_mat), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Error BP |','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',multiple_CI_means(data_mat,0,0));
pbaspect(gca, [x_ax_scale 1 1])
...
fprintf('%s Variance\n',metrics_cell{4})
boxplot_multcompare(abs(bsxfun(@minus,data_mat,median(data_mat,1))), group_ids, 'TargetValue',0,'y_axis_text',...
    '| Res. Median Error BP |  ','group_labels',prettify_groups(group_ids),'IncludeTopRank',0,...
    'IncludeTargetWithinRange',0,'StatAnalysis','Variance');
pbaspect(gca, [x_ax_scale 1 1])

mkdir([getappdata(0,'proj_path') '/temp/'])
